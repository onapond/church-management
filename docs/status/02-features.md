...
| 유형 | 아이콘 | 주요 필드 |
|------|--------|----------|
| 주차 보고서 (weekly) | 📋 | 출결 현황, 새신자 명단, 순서지, 말씀 정보 |
| 모임 보고서 (meeting) | 👥 | 모임 개요, 참석자, 주요 내용 |
| 교육 보고서 (education) | 📚 | 교육 개요, 교육 내용, 적용점 |
| 셀장 보고서 (cell_leader) | 🏠 | 셀 모임명, 참석자, 나눔 내용, 기도제목 |
| 프로젝트 계획 (project) | 📑 | 프로젝트 개요, 일정, 예산 |
| 심방 보고서 (visitation) | 🙏 | 심방 대상자, 날짜, 심방 내용, 기도제목 |
...
- 결재 흐름 및 이력 표시
- **유형별 결재 흐름 지원**:
  - 일반 보고서 (주차, 모임 등): 4단계 결재 (협조 → 결재 → 확인)
  - 셀장 보고서: 2단계 결재 (제출 → 부서장 확인 후 즉시 최종 승인)
- 역할별 결재 액션
  - 협조 (회장)
  - 결재 (부장)
  - 확인 (목사, 부서장)
...
- **관리자/결재자 (super_admin, president, accountant)**: 모든 부서의 모든 보고서 열람
- **부서장 (is_team_leader=true)**: 모든 부서의 모든 보고서 열람
- **셀장 (role=team_leader, is_team_leader=false)**: 소속 부서 내의 '주차 보고서'와 '셀장 보고서'만 열람 가능
- **일반 멤버**: 본인이 작성한 보고서만 열람 가능
...
- 역할별 결재 대기 목록 (셀장 보고서는 부서장에게만 노출)
- 대기 중 / 처리 완료 탭
- 보고서 상세 페이지로 이동
