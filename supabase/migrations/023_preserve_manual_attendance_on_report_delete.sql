-- Report deletion invokes attendance triggers recursively. Skip summary writes
-- during that nested cleanup and detach manually corrected rows before the
-- report-origin rows are removed.
